...
public class Messages {
  ...
  public static class AudioTrackMessage {
    ...
    public @Nullable List<String> getAudioTrackNames() { return audioTrackNames; }
    public void setAudioTrackNames(@Nullable List<String> setterArg) {
      this.audioTrackNames = setterArg;
    }

    private @Nullable Long index;
    public @Nullable Long getIndex() { return index; }
    ...
    public static final class Builder {
      ...
      private @Nullable List<String> audioTrackNames;
      public @NonNull Builder setAudioTrackNames(@Nullable List<String> setterArg) {
        this.audioTrackNames = setterArg;
        return this;
      }
      private @Nullable Long index;
    ...
    @NonNull Map<String, Object> toMap() {
      Map<String, Object> toMapResult = new HashMap<>();
      toMapResult.put("textureId", textureId);
      toMapResult.put("audioTrackNames", audioTrackNames);
      toMapResult.put("index", index);
      return toMapResult;
    }
    static @NonNull AudioTrackMessage fromMap(@NonNull Map<String, Object> map) {
      AudioTrackMessage pigeonResult = new AudioTrackMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
      Object audioTrackNames = map.get("audioTrackNames");
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
          return AudioTrackMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      if (value instanceof AudioTrackMessage) {
        stream.write(128);
        writeValue(stream, ((AudioTrackMessage) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    @NonNull AudioTrackMessage getAvailableAudioTracksList(@NonNull TextureMessage msg);
    void setActiveAudioTrack(@NonNull AudioTrackMessage msg);
    void setActiveAudioTrackByIndex(@NonNull AudioTrackMessage msg);
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.getAvailableAudioTracksList", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              AudioTrackMessage output = api.getAvailableAudioTracksList(msgArg);
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrack", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.setActiveAudioTrack(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrackByIndex", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.setActiveAudioTrackByIndex(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
