...
abstract class TestHostVideoPlayerApi {
  ...
  AudioTrackMessage getAvailableAudioTracksList(TextureMessage arg);
  void setActiveAudioTrack(AudioTrackMessage arg);
  void setActiveAudioTrackByIndex(AudioTrackMessage arg);
  ...
  static void setup(TestHostVideoPlayerApi? api) {
    ...
    {
      const BasicMessageChannel<Object?> channel =
          BasicMessageChannel<Object?>('dev.flutter.pigeon.VideoPlayerApi.getAvailableAudioTracksList', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.getAvailableAudioTracksList was null. Expected TextureMessage.');
          final TextureMessage input = TextureMessage.decode(message!);
          final AudioTrackMessage output = api.getAvailableAudioTracksList(input);
          return <Object?, Object?>{'result': output.encode()};
        });
      }
    }
    {
      const BasicMessageChannel<Object?> channel =
          BasicMessageChannel<Object?>('dev.flutter.pigeon.VideoPlayerApi.setActiveAudioTrack', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setActiveAudioTrack was null. Expected AudioTrackMessage.');
          final AudioTrackMessage input = AudioTrackMessage.decode(message!);
          api.setActiveAudioTrack(input);
          return <Object?, Object?>{};
        });
      }
    }
    {
      const BasicMessageChannel<Object?> channel =
          BasicMessageChannel<Object?>('dev.flutter.pigeon.VideoPlayerApi.setActiveAudioTrackByIndex', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setActiveAudioTrackByIndex was null. Expected AudioTrackMessage.');
          final AudioTrackMessage input = AudioTrackMessage.decode(message!);
          api.setActiveAudioTrackByIndex(input);
          return <Object?, Object?>{};
        });
      }
    }
