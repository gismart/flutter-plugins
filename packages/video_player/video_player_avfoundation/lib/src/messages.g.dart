...
class IsHlsAvailableOfflineMessage {
  ...
  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['isAvailableOffline'] = isAvailableOffline;
    return pigeonMap;
  }
...
class AVFoundationVideoPlayerApi {
  ...
  Future<AudioTrackMessage> getAvailableAudioTracksList(TextureMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableAudioTracksList', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
  ...
  Future<void> setActiveAudioTrack(AudioTrackMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AVFoundationVideoPlayerApi.setActiveAudioTrack', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
  ...
  Future<void> setActiveAudioTrackByIndex(AudioTrackMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AVFoundationVideoPlayerApi.setActiveAudioTrackByIndex', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
  ...
  Future<IsHlsAvailableOfflineMessage> isHlsAvailableOffline(HlsStreamMessage arg_msg) async {
    ...
    if (replyMap == null) {
      ...
      return (replyMap['result'] as IsHlsAvailableOfflineMessage?)!;
    }
  }
