...
- (NSDictionary *)toMap;
@end
@interface FLTAudioTrackMessage ()
+ (FLTAudioTrackMessage *)fromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
@implementation FLTAudioTrackMessage
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
    audioTrackNames:(nullable NSArray<NSString *> *)audioTrackNames
    index:(nullable NSNumber *)index {
  FLTAudioTrackMessage* pigeonResult = [[FLTAudioTrackMessage alloc] init];
  pigeonResult.textureId = textureId;
...
+ (FLTAudioTrackMessage *)fromMap:(NSDictionary *)dict {
  ...
  pigeonResult.textureId = GetNullableObject(dict, @"textureId");
  NSAssert(pigeonResult.textureId != nil, @"");
  pigeonResult.audioTrackNames = GetNullableObject(dict, @"audioTrackNames");
  pigeonResult.index = GetNullableObject(dict, @"index");
  return pigeonResult;
}
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.textureId ? self.textureId : [NSNull null]), @"textureId", (self.audioTrackNames ? self.audioTrackNames : [NSNull null]), @"audioTrackNames", (self.index ? self.index : [NSNull null]), @"index", nil];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type 
{
  switch (type) {
    case 128:     
      return [FLTAudioTrackMessage fromMap:[self readValue]];
...
{
  if ([value isKindOfClass:[FLTAudioTrackMessage class]]) {
    [self writeByte:128];
...
void FLTAVFoundationVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAvailableAudioTracksList"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getAvailableAudioTracksList:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(getAvailableAudioTracksList:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTTextureMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        FLTAudioTrackMessage *output = [api getAvailableAudioTracksList:arg_msg error:&error];
        callback(wrapResult(output, error));
      }];
    }
    else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setActiveAudioTrack"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setActiveAudioTrack:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(setActiveAudioTrack:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTAudioTrackMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setActiveAudioTrackByIndex"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setActiveAudioTrackByIndex:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(setActiveAudioTrackByIndex:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTAudioTrackMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
